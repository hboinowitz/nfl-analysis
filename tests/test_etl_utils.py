...
class TestETLUtils:
    ...
    def test_parse_historic_team_names(self, mapping):
        expected_rams_tuple = ('Los Angeles Rams', ['Los Angeles Rams', 'St. Louis Rams'])
        expected_cardinals_tuple = ('Arizona Cardinals', ['Arizona Cardinals'])
        assert expected_rams_tuple == utils.parse_historic_team_names("Los Angeles Rams(St. Louis Rams 1995–2015)")
        assert expected_cardinals_tuple == utils.parse_historic_team_names("Arizona Cardinals")
