...
(
    ...
    combined_wins_and_losses,
) = utils.get_cumulated_wins_per_division(superbowls, mapping, teams)

wins_and_losses_per_division_figure = utils.plot_wins_and_losses_per_division(
    wins_and_losses_per_division_cumulated, "NFC", "East"
)

apperances_per_division = combined_wins_and_losses.groupby(["league", "division"]).agg(
